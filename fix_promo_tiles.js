...
// Add Promo Tiles CRUD UI right below Hero Slides
const promoUI = `
            {/* Promo Tiles CRUD */}
...
`;
content = content.replace(
  '              <h3 className="text-lg font-semibold mb-2">Store Configuration</h3>',
  promoUI + '\n              <h3 className="text-lg font-semibold mb-2 mt-8">Store Configuration</h3>'
);
