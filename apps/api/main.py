...
from modules.admin.marketing_router import router as admin_marketing_router
...
app.include_router(bank_offers_router, prefix="/api/v1/store")
app.include_router(bank_offers_admin_router, prefix="/api/v1/admin")
