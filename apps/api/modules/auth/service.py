...
from modules.auth.schemas import UserCreate, UserLogin, TokenResponse
...
class AuthService:
    ...
    def create_access_token(self, subject: str, roles: list[str], business_id: str = None) -> str:
    ...
    async def authenticate_user(self, data: UserLogin) -> TokenResponse:
        ...
        if not user.is_active:
            raise DomainException("Account is disabled", code="FORBIDDEN", status_code=403)
