...
class BusinessService:
    ...
    async def create_business(self, data: BusinessCreate) -> Business:
        ...
        if existing:
            raise DomainException(message="A business with this slug already exists", code="SLUG_TAKEN")
    ...
    async def get_business(self, business_id: str) -> Business:
        ...
        if not business:
            raise DomainException(message="Business not found", code="NOT_FOUND", status_code=404)
        return business
